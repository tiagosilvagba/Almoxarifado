...
/** Bootstrap 8.8: desacelera a rotação dos modais e separa quantidades solicitada e entregue. */
const BOOTSTRAP_VERSION = "8.8";
const IS_IOS = /iPad|iPhone|iPod/.test(navigator.userAgent)
  || (navigator.platform === "MacIntel" && navigator.maxTouchPoints > 1);

const MODULES = Object.freeze({
  base: "./app/layers/features.js?v=8.8",
  ...
  imageViewer: "./app/modules/image-viewer.js?v=8.8",
